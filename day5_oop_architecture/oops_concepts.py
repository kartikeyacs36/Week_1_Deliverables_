...
class Car:
    car_type = "SUV" #this is a class variable ; it is shared by all objects
...
print(MG.drive())
print(Car.is_car(MG))
audi= Car("Audi", "Q5", 2026)
print(audi.car_type) # accessing the class variable
print(audi.brand)
print(audi.model)
print(audi.year)
...
class Bank:
    def __init__(self):
        self.__balance = 10000 #private variable ( if the object try to access it driectly ,  it will throw an error)
...
class Lion(Animal):
    def sound(self):
        print("Roar") # overriding the method in parent class
l = Lion()
l.sound()